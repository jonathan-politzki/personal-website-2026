...
History shows us instances where one directionally invents something that solves a problem that surfaces years later in another field (the invention of the transformer). Or it takes time to really digest an invention.
...
But it was only because he was crazy enough to pursue crazy ideas that he was able to solve an incredibly large problem relating to differential geometry that would change the course of history.
...
To try to solve a large problem means to think you can solve it. What could possibly make you think you can solve it? Is it hubris? Risk appetite? Irrationality? Stubbornness? Pure insanity? Ambition for power, fame, and fortune? A chip on one’s shoulder? There is some blend of human emotions that can approximate or present themselves as insanity, idiocy, ambition, and disagreeableness.
...
Equally, we can mock the midwest and NYC. But here’s the thing, if we bombed the midwest and Financial Capital of the world, we would definitely notice.
...
If you are the United States, your stability is more of a feature than it is a bug. If you are a mature company, this is also true. Most software companies, for instance, dedicate 15-25% of their budget to R&D.
