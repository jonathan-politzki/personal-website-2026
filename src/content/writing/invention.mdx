...
This seems to happen more often than we would think. Where one directionally invents something that solves a problem that surfaces years later in another field. Or it takes time to really digest an invention.
