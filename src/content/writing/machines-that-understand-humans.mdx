...
> _“There are three things extremely hard: steel, a diamond, and to know one’s self.” - Benjamin Franklin_
...
<FactorList title="The structure: to come back to">
  ...
  <Factor name="Market Landscape">
    A deep examination of existing approaches. Model layer: Simile AI, Unbox AI, Humans&amp;, Aaru. Data layer: not sure. Dev tools: the AI memory players, Shaped AI. App layer: many of the personalized AI players. Notably, much of large tech exists as the app, data, and model layer at once. Walled gardens.
  </Factor>
