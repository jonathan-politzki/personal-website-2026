...
export default function Nav() {
  ...
  return (
    <>
      <div className="fixed top-0 right-0 p-6 md:p-8 z-50 pointer-events-none flex justify-between w-full items-start">
        {/* Logo - Top Left */}
        ...
        <button 
          ...
          className="pointer-events-auto p-2 hover:bg-white/10 text-white/50 hover:text-white transition-colors"
        >
        ...
        {isOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed top-0 right-0 h-full w-80 bg-[#0a0a0a] border-l border-[#222] z-[101] flex flex-col shadow-2xl"
            >
              {/* Close Button */}
